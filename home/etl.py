...
def process_data(cur, conn, filepath, func):
    """
    Find all ".json" files in filepath and process each using the func
    cur: cursor object (psycopg2) from connection to the target database
    conn: (psycopg2) connection object to the target database
    filepath: path to the folder containing the files to be processed
    func: the function to be used to process the data.
    """
...
def main():
     """
    Runs the etl for the sparkifydb
    """
